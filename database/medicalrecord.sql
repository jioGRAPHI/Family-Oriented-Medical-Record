...
CREATE TABLE `patientdepressionscale` (
  ...
  `q_8` int(1) DEFAULT 0,
  `q_9` int(1) DEFAULT 0,
  `q_10` int(1) DEFAULT 0,
  `q_11` int(1) DEFAULT 0,
  `q_12` int(1) DEFAULT 0,
  `q_13` int(1) DEFAULT 0,
  `q_14` int(1) DEFAULT 0,
  `q_15` int(1) DEFAULT 0,
...
DROP TABLE IF EXISTS `patientassessmenttree`;
CREATE TABLE `patientassessmenttree` (
  `log_id` int(10) NOT NULL AUTO_INCREMENT,
